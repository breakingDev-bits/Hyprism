...
git clone [https://github.com/hyprismteam/Hyprism.git](https://github.com/hyprismteam/Hyprism.git)
cd Hyprism
...
The English and Russian documentation is available on the [Hyprism documentation site](https://hyprismteam.github.io/Hyprism/docs/). Its Docusaurus sources live in [`Docs/content`](https://www.google.com/search?q=Docs/content)
...
* Full license text: [LICENSE](https://www.google.com/search?q=LICENSE)
* License texts used by project assets: [Licenses](https://www.google.com/search?q=License)
* Machine-readable licensing and CI compliance: [REUSE.toml](https://www.google.com/search?q=REUSE.toml)
* Project logo and banner assets: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/), with the license text in [Licenses/CC-BY-SA-4.0.txt](https://www.google.com/search?q=Licenses/CC-BY-SA-4.0.txti)
...
The developers of Hyprism constitute no control over the content hosted on any user-added external mirrors. The responsibility for choosing a download source and ensuring compliance with the [Hytale EULA](https://hytale.com/eulai) and applicable copyright laws rests entirely with the end-user
