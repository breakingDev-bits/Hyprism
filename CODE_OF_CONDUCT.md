...
This Code of Conduct applies in all project spaces, including issues, pull requests, discussions, chat channels, and other community interactions

## Reporting

If you experience or witness unacceptable behavior, please report it to the maintainers
You can open a private report by contacting the project maintainer team through the repository owners

## Enforcement

Maintainers are responsible for clarifying and enforcing this Code of Conduct and may take appropriate action in response to unacceptable behavior

## Attribution

This document is inspired by common open-source community standards, including the Contributor Covenant
