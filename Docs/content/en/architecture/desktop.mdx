...
`UI/Foundation/Themes/HyprismTheme.axaml` provides the application-owned templates for the window, scrolling, text input, selection, list, combo box, progress, tooltip, and popup surfaces. `UI/Foundation/Tokens` contains primitive, semantic, and control tokens. `UI/Components/Components.axaml` defines shared control families, while `UI/Foundation/GlobalStyles.axaml` contains application-wide selectors. Feature style dictionaries are registered through `UI/FeatureStyles.axaml` and live next to their owning feature
...
| `EmptyState` | Consistent empty content hierarchy with feature-provided icon, text, and action |
...
Source: [MainWindowViewModel](../../../../Sources/Hyprism.Desktop/Shell/MainWindowViewModel.cs), [InstancesViewModel](../../../../Sources/Hyprism.Desktop/Features/Instances/InstancesViewModel.cs), [NewsViewModel](../../../../Sources/Hyprism.Desktop/Features/News/NewsViewModel.cs), [Shared controls](../../../../Sources/Hyprism.Desktop/UI/Controls)
