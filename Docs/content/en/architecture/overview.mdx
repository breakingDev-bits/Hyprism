...
| --- | --- | --- |
| Domain services and persisted state | Core | [Core responsibilities](/docs/architecture/core) |
| Views, commands, native dialogs, browser links | Desktop | [Desktop composition](/docs/architecture/desktop) |
| Autonomous authentication and local compatibility API | Local Node | [Protocol and lifecycle](/docs/reference/local-node) |
| Installation and game processes | Core with host capabilities | [Launch workflow](/docs/architecture/game-lifecycle) |
| Storage, migrations, and diagnostics | Each owning service | [Data and cache](/docs/architecture/data-and-cache) |
...
Use the [contract reference](/docs/reference/services) before adding another service, and cover changes with the matching [test suite](/docs/development/testing)
