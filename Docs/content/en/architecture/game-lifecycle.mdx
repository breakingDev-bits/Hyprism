...
Autonomous launch starts Local Node before client preparation, obtains session tokens, and applies the node's certificate trust to the game. See [Local Node](/docs/reference/local-node) for protocol and certificate details
