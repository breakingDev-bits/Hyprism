...
Offline profiles can use a connected custom authentication service or the on-device [Local Node](/docs/reference/local-node). They do not receive official entitlements, cloud identity, or centralized social features
