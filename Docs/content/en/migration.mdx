...
See the [architecture overview](/architecture/overview) for current project ownership and [packaging](/development/packaging) for release entry points

## Remaining gaps

The first-run onboarding UI and per-instance log viewer are not implemented. Players create a profile and instance manually through [First run](/getting-started/first-run), and inspect diagnostic files through the [data directory](/architecture/data-and-cache)
