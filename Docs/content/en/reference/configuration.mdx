...
`JsonConfigStore` reads and writes `Config.json` in the [application directory](/docs/architecture/data-and-cache). JSON properties use PascalCase and are read case-insensitively
...
| `HYPRISM_WIN32_COMPOSITION` | Windows rendering diagnostic override, see [performance](/docs/development/avalonia-performance) |
| `HYPRISM_DOCS_SCREENSHOTS` | Opt-in output directory for [documentation captures](/docs/development/documentation#screenshots) |
