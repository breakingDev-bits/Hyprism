...
Managed logs use the launcher's [session log directory](/docs/architecture/data-and-cache). Authentication diagnostics omit headers, token values, and request bodies
